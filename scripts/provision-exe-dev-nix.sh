...
Optional:
  ...
  HOME_MANAGER_ENABLE_BROWSER_TOOLS
  HOME_USERNAME
  HOME_DIRECTORY
  HOME_STATE_VERSION
USAGE
...
HOME_MANAGER_ENABLE_BROWSER_TOOLS="$(config_value HOME_MANAGER_ENABLE_BROWSER_TOOLS "$TARGET_CONFIG")"
HOME_MANAGER_ENABLE_BROWSER_TOOLS="${HOME_MANAGER_ENABLE_BROWSER_TOOLS:-0}"
...
HM_ENABLE_BROWSER_TOOLS="$9"
HM_USERNAME="${10}"
HM_HOME_DIRECTORY="${11}"
HM_STATE_VERSION="${12}"
TOOLNIX_REF="${13}"
ROOT_DISK_HEADROOM_MB="${14}"
ENABLE_DISK_CLEANUP_RETRY="${15}"
...
if [ "$HM_ENABLE_BROWSER_TOOLS" = "1" ]; then
  bootstrap_args+=(--enable-browser-tools)
fi
